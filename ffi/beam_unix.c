...
LEAN_EXPORT lean_obj_res lean_beam_unix_listen(b_lean_obj_arg path, lean_obj_arg world) {
  (void)world;
...
LEAN_EXPORT lean_obj_res lean_beam_unix_accept(b_lean_obj_arg fd_obj, lean_obj_arg world) {
  (void)world;
...
LEAN_EXPORT lean_obj_res lean_beam_unix_connect(b_lean_obj_arg path, lean_obj_arg world) {
  (void)world;
  char const *path_c = lean_string_cstr(path);
  int fd = socket(AF_UNIX, SOCK_STREAM, 0);
  if (fd < 0) return mk_io_error_from_errno("socket", path_c);
...
LEAN_EXPORT lean_obj_res lean_beam_unix_close(b_lean_obj_arg fd_obj, lean_obj_arg world) {
  (void)world;
  uint32_t fd_u32 = lean_unbox_uint32(fd_obj);
  int fd = (int)fd_u32;
...
LEAN_EXPORT lean_obj_res lean_beam_unix_send_msg(b_lean_obj_arg fd_obj, b_lean_obj_arg msg,
                                                  lean_obj_arg world) {
  (void)world;
  uint32_t fd_u32 = lean_unbox_uint32(fd_obj);
  int fd = (int)fd_u32;
...
LEAN_EXPORT lean_obj_res lean_beam_unix_recv_msg(b_lean_obj_arg fd_obj, lean_obj_arg world) {
  (void)world;
  uint32_t fd_u32 = lean_unbox_uint32(fd_obj);
  int fd = (int)fd_u32;
  char header[64];
