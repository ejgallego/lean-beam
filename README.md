...
position, then returns structured feedback such as hover information, goals, diagnostics, or the
result of trying a small Lean fragment in the surrounding module context.
...
If a speculative result should become real source, edit the file, save it, and then run
`lean-beam sync`.
...
- Agent workflows, including Codex and Claude Code, that need a small typed Lean interaction
  surface.
