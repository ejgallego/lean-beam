...
Progress, status, streamed diagnostics, and current summaries are separate reporting concepts.
...
enable diagnostic logging and/or request `full_diagnostics: true` plus `include_diagnostics: true`.
